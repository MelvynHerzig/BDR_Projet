...
( 'John', 'Doe', 'johnny@unc.com', 'johnny', '2000-01-01' ),
( 'Pierre', 'Kiroule', 'pierre@sansequipe.com', 'pierre', '1990-01-01' );
...
( 'EE', 13,  '2020-01-01 00:00:00', '2020-12-28 17:00:00' ),
( 'EE', 14,  '2020-01-01 00:00:00', NULL ),
( 'EE', 15,  '2020-01-01 00:00:00', NULL ),
( 'VIT', 16,  '2020-01-01 00:00:00', '2020-12-27 20:00:00' ),
( 'VIT', 17,  '2020-01-01 00:00:00', NULL ),
( 'VIT', 18,  '2020-01-01 00:00:00', NULL ),
( 'DIG', 19,  '2020-01-01 00:00:00', '2020-12-26 19:00:00' ),
...
( 'VIT', 19,  '2020-12-28 00:00:00', NULL ),
( 'DIG', 16,  '2020-12-29 00:00:00', NULL ),
...
( NOW(), 'Tournoi de préparation en cours', 2, NULL ),
( NOW(), 'Tournoi de préparation annulé', 2, NULL );
...
FOR EACH ROW
BEGIN
	IF (estEnAttente(NEW.idTournoi))
    THEN
		SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Le tournoi n\'a pas encore commencé, le match ne peut pas être inséré.';
	END IF;
